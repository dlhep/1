...
const data = {"title": "Residential Architects Birmingham", "meta": "Residential architects in Birmingham for extensions, loft conversions, new homes, planning applications and Building Regulations.", "h1": "Residential architects in Birmingham.", "intro": "Hepburn Architects provides feasibility, planning, design and Building Regulations services for homeowners and residential developers across Birmingham.", "areas": "Including Edgbaston, Harborne, Moseley, Sutton Coldfield, Kings Heath and surrounding areas."};

export const metadata: Metadata = {
  title: data.title,
  description: data.meta,
  alternates: { canonical: `/locations/birmingham` },
  openGraph: {
    title: `${data.title} | Hepburn Architects`,
    description: data.meta,
    url: `https://www.hepburnarchitects.net/locations/birmingham`
  }
};
