...
const data = {"title": "Residential Architects Solihull", "meta": "Residential architects in Solihull for house extensions, loft conversions, planning and Building Regulations.", "h1": "Residential architects serving Solihull.", "intro": "We support residential projects from early feasibility through planning permission and technical drawings.", "areas": "Including central Solihull, Knowle, Dorridge, Shirley and surrounding areas."};
