...
const data = {"title": "Residential Architects Teesside", "meta": "Residential architects across Teesside for extensions, lofts, new homes, HMOs, planning and Building Regulations.", "h1": "Residential architects across Teesside.", "intro": "We help homeowners and residential developers understand feasibility, planning risk and the technical route to construction.", "areas": "Serving Middlesbrough, Stockton-on-Tees, Redcar, Yarm and surrounding areas."};

export const metadata: Metadata = {
  title: data.title,
  description: data.meta,
  alternates: { canonical: `/locations/teesside` },
  openGraph: {
    title: `${data.title} | Hepburn Architects`,
    description: data.meta,
    url: `https://www.hepburnarchitects.net/locations/teesside`
  }
};
